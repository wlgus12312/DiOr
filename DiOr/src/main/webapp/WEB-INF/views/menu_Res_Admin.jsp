...
<script type="text/javascript">	
	function foodAdd() {
		var stono = 
		window.open("/menu_Res_Admin_M_Pop?storeId="+document.getElementsByName("storeId")[0].value
		          , "음식 등록"
...
<div class="w3-main w3-content w3-padding" style="max-width:auto;margin-top:50px">
	<table align="center">
		<tr>
			<td width="905px" align="right"><input type="button" class="w3-bar-item w3-black w3-button" value="음식 추가" onclick="foodAdd();"></td>
		</tr>
	</table>
	<!-- table Grid-->
	...
	<table class= "w3-table-all w3-cell-row">
		...
		<tr>
			<td align="left">
				${item.stonm}
				<input type="hidden" id="storeId" name="storeId" value="${item.stono}">
			</td>
